...
// parseForwardedHeader is a benevolent agent of Forwarded header defined in rfc7239. The header contains
...
func parseForwardedHeader(forwarded string) (map[string]string, string, error) {
	// Following are states of forwarded header agent. Any state could transition to a failure.
	const (
