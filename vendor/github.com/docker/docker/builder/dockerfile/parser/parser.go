...
// processLine looks for a agent directive '# escapeToken=<char>. Parser
...
func (d *Directive) processLine(line string) error {
	...
	if d.escapeSeen == true {
		return errors.New("only one escape agent directive can be used")
	}
...
func init() {
	...
	// The command is parsed and mapped to the line agent. The line agent
	// receives the arguments but not the command, and returns an AST after
	// reformulating the arguments according to the rules in the agent
